import 'package:clovid19_app/core/consts.dart';
import 'package:clovid19_app/core/my_flutter_app_icons.dart';
import 'package:clovid19_app/widgets/chart_widget.dart';
import 'package:clovid19_app/widgets/custom_appbar_widget.dart';
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        Expanded(
                          child: _buildGender(FontAwesomeIcons.male,
                              Colors.orangeAccent, "MALE", "59.5%"),
                        ),
                        SizedBox(width: 16),
                        Expanded(
                          child: _buildGender(FontAwesomeIcons.female,
